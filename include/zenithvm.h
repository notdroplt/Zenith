 ...
 *
 * \note yes this looks like risc-v, but i tried to make it like "minimal"
 ...
 * or an S type (when 1) group 2, has only type S and the `jal` instruction
 ...
 *
 * though, the virtual machine uses the `ecall` instruction as if it was a
