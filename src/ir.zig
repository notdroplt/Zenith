...
pub const IR = struct {
    ...
    pub const Value = struct {
        vtype: *Types.Type = undefined, // owning
        from: BlockOffset = 0,
        args: ?*[]Value = null,
        value: union(enum) {
            constant: void,
    ...
    pub fn fromNode(self: *IR, node: *Parser.Node) !void {
    ...
    fn calculateLoadSize(self: *IR, value: *Types.Type) IRError!SNIR.Opcodes {
    ...
    fn calculateStoreSize(value: *Types.Type) IRError!SNIR.Opcodes {
        if (value.data == .decimal)
    ...
    fn blockNode(self: *IR, currblock: BlockOffset, node: *Parser.Node) IRError!Value {
        switch (node.data) {
    ...
    fn constantFromType(self: *IR, block: BlockOffset, node: *Parser.Node) Value {
    ...
    fn blockInteger(self: *IR, block: BlockOffset, node: *Parser.Node) Value {
        return self.constantFromType(block, node);
    }

    fn blockDecimal(self: *IR, block: BlockOffset, node: *Parser.Node) Value {
        return self.constantFromType(block, node);
    }

    fn blockReference(self: *IR, block: BlockOffset, node: *Parser.Node) IRError!Value {
    ...
    fn blockUnary(self: *IR, block: BlockOffset, node: *Parser.Node) IRError!Value {
        if (node.ntype.?.isValued())
            return self.constantFromType(block, node);
    ...
    fn getBinaryOp(self: *IR, from: BlockOffset, node: *Parser.Node, lreg: SNIR.InfiniteRegister, rreg: SNIR.InfiniteRegister) !SNIR.Opcodes {
    ...
    fn blockBinary(self: *IR, block: BlockOffset, node: *Parser.Node) IRError!Value {
        if (node.ntype.?.isValued())
            return self.constantFromType(block, node);
    ...
    fn blockTernary(self: *IR, block: BlockOffset, node: *Parser.Node) IRError!Value {
        if (node.ntype.?.isValued())
            return self.constantFromType(block, node);
    ...
    fn blockIntermediate(self: *IR, block: BlockOffset, node: *Parser.Node) IRError!Value {
    ...
    fn blockCall(self: *IR, block: BlockOffset, node: *Parser.Node) !Value {
    ...
    fn blockExpr(self: *IR, block: BlockOffset, node: *Parser.Node) IRError!Value {
